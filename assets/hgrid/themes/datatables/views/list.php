...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="groceryCrudTable">
	<thead>
		<tr>
			...
			<th class='actions'>actions<?php //echo $this->l('list_actions'); ?></th>
			<?php }?>
			...
			<td class='actions'>
				...
				<?php if(!$unset_edit){?>
					<a href="<?php //echo $row->edit_url?>" class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button">
						...
						<span class="ui-button-text">&nbsp;edit<?php //echo $this->l('list_edit'); ?></span>
					</a>
				<?php }?>
				<?php if(!$unset_delete){?>
					<a onclick = "javascript: return delete_row('<?php //echo $row->delete_url?>', '<?php echo $num_row?>')" 
						...
						<span class="ui-button-text">&nbsp;delete<?php //echo $this->l('list_delete'); ?></span>
					</a>
				<?php }?>
			</td>
			<?php }?>
	...
	<tfoot>
		<tr>
			<?php foreach($columns as $column){?>
				<th><input type="text" name="<?php echo $column->field_name; ?>" placeholder="search<?php //echo $this->l('list_search').' '.$column->display_as; ?>" class="search_<?php echo $column->field_name; ?>" /></th>
			<?php }?>
			<?php if(!$unset_delete || !$unset_edit || !empty($actions)){?>
				<th>
